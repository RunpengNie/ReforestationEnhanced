...
SELECT 'IMPROVEMENT_PLANT_JUNGLE',1,1,'TXT_KEY_IMPROVEMENT_PLANT_JUNGLE','TXT_KEY_CIV5_IMPROVEMENTS_PLANT_JUNGLE_HELP','TXT_KEY_CIV5_IMPROVEMENTS_PLANT_JUNGLE_TEXT','ART_DEF_IMPROVEMENT_PLANT_JUNGLE','REFOREST_ATLAS',1;
...
SELECT 'IMPROVEMENT_PLANT_JUNGLE','FLAVOR_PRODUCTION',5;
...
SELECT 'BUILD_FOREST','TECH_FERTILIZER',900,'IMPROVEMENT_PLANT_FOREST','TXT_KEY_BUILD_FOREST','TXT_KEY_BUILD_FOREST_HELP','TXT_KEY_BUILD_FOREST_REC','ENTITY_EVENT_IRRIGATE','KB_F',37,'UNIT_ACTION_REFOREST_ATLAS',0 UNION ALL
SELECT 'BUILD_JUNGLE','TECH_FERTILIZER',900,'IMPROVEMENT_PLANT_JUNGLE','TXT_KEY_BUILD_JUNGLE','TXT_KEY_BUILD_JUNGLE_HELP','TXT_KEY_BUILD_JUNGLE_REC','ENTITY_EVENT_IRRIGATE','KB_J',36,'UNIT_ACTION_REFOREST_ATLAS',1;
...
SELECT 'BUILD_FOREST','FEATURE_MARSH','TECH_FERTILIZER',900,0,1 UNION ALL
SELECT 'BUILD_JUNGLE','FEATURE_JUNGLE','TECH_FERTILIZER',900,40,1 UNION ALL
...
SELECTType, 'BUILD_FOREST'
FROM Units WHERE Class = 'UNITCLASS_WORKER' UNION ALL
SELECTType, 'BUILD_JUNGLE'
